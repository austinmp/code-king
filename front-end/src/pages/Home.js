...
const Home = ({ setModal }) => {
  const { credentials, isLoggedIn } = useContext(AuthContext);
  ...
  return (
    <>
      <PageContainer>
        <HeaderContainer>
          <img src="/code-king-logo.png" alt="monkey with laptop logo" width="150"/>
          <div>
            <Header text="Code King"/>
          </div>          
          <h3 className="description">
            A coding challenge website built using microservices for
            <a href="https://sites.google.com/cs.umass.edu/compsci497s/home" > CS497S - Scalable Web Systems</a>
          </h3>
          <div> 
            Special thanks to{' '}  
            <a href="https://github.com/Derpthemeus"> Matthew Oslan</a>,{' '}
            <a href="https://github.com/thinhphamcs">Thinh Pham</a>, {' '}
            <a href="https://github.com/jitli98">Gerry Gan</a>, and {' '}
            <a href="https://github.com/dergoose">Veronica Gusev</a>{' '}
      ...
      <PageContainer>
        <Grid className="grid">
          { isLoggedIn
          ? <a href={`/submissions/${credentials.username}`} className="card" >
              ...
              <h3>Welcome, {credentials.username}! &rarr;</h3>
              <P>View or edit your past submissions.</P>
            </a>
          : <a href="#"
              className="card"
              onClick={() => {
          ...
          <a
            href="https://github.com/austinmp/code-king"
            className="card"
          >
